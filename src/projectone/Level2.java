...
public class Level2 extends BasicGameState {
	...
	public void update(GameContainer container, StateBasedGame game, int delta) throws SlickException 
	{
		...
		if(inputCoolDown <= 0) 
		{
			...
			if(moved) 
			{
				...
				p1.monster.moveMonstertoPath(p1 , p1.maze2, p1.monster.currenttiley, p1.monster.currenttilex,
											p1.player.tileY, p1.player.tileX);
				p1.monster2.moveMonstertoPath(p1 , p1.maze2, p1.monster2.currenttiley, p1.monster2.currenttilex,
						p1.player.tileY, p1.player.tileX);
			}
		}
		else
	...
	{
		int currentTile = p1.maze2[newTileY][newTileX];
	...
	{
		if(p1.maze2[newTileY][newTileX] == 1)
			return true;
		return false;
	}
